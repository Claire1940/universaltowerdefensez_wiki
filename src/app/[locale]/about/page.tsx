...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.universaltowerdefensez.wiki'
  const path = '/about'

  return {
    title: 'About Universal Tower Defense Z Wiki - Your Ultimate Roblox Game Resource',
    description: 'Learn about Universal Tower Defense Z Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Universal Tower Defense Z Roblox game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              codes, unit tier lists, trait strategies, and raid walkthroughs to enhance your gaming experience.
            </p>
            <p>
              Whether you're a new player just starting your tower defense journey or a seasoned veteran looking to optimize your unit roster,
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <ul>
              ...
              <li><strong>Build useful tools:</strong> Develop tier list planners, code trackers, and unit guides that help players make informed decisions</li>
            ...
            <p>
              ...
              active codes, want to check the unit tier list, or are looking for advanced raid tactics.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Up-to-date Universal Tower Defense Z codes with redemption steps and reward tracking.
                Never miss free Trait Rerolls, Gems, or Gold!
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Detailed guides on every unit, including rarity, acquisition, stats, and roles.
                Build the strongest anime tower defense roster.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">🏆</div>
              <h3 className="text-xl font-semibold text-white mb-2">Tier List</h3>
              <p className="text-slate-300">
                S/A/B tier rankings for DPS, support, farm, and hybrid units, updated for the current meta.
                Know which units are worth investing in.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">✨</div>
              <h3 className="text-xl font-semibold text-white mb-2">Traits & Evolution</h3>
              <p className="text-slate-300">
                Trait reroll advice, evolution paths, and etherealize guides to maximize each unit's potential.
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Walkthroughs for Story, Raids, Challenges, Virtual Realm, and Infinite modes.
                Master every tower defense mode and maximize rewards.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                ...
                and Japanese to serve Roblox players worldwide.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              <strong>Want to contribute?</strong> Whether you've discovered a new code, found a strong unit combo,
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-slate-400 italic text-sm">
              Project Codename: "UTDZ Hub" – Defending every wave together.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@universaltowerdefensez.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@universaltowerdefensez.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@universaltowerdefensez.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@universaltowerdefensez.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@universaltowerdefensez.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@universaltowerdefensez.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@universaltowerdefensez.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@universaltowerdefensez.wiki
                </a>
              </div>
            </div>
