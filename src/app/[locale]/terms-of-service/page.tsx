      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <ul>
              <li>Game guides and strategy tips</li>
              <li>Codes, units, and tier list guides</li>
              <li>Trait and evolution guides</li>
              <li>Unit and enemy guides</li>
              <li>Raid and game mode walkthroughs</li>
            ...
            <p>
              ...
              Roblox Corporation or the official developers of Universal Tower Defense Z. We are an independent fan community.
            </p>
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> Roblox game content and updates may change without notice. We are not responsible for game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, UNIVERSAL TOWER DEFENSE Z WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@universaltowerdefensez.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@universaltowerdefensez.wiki</a>
            </p>
            <p>
