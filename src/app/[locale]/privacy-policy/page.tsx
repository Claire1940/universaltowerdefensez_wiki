        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              with Roblox Corporation or the developers of Universal Tower Defense Z. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@universaltowerdefensez.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@universaltowerdefensez.wiki</a>
            </p>
            <p>
