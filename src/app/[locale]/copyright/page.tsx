      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Universal Tower Defense Z Wiki. All rights reserved.
            </p>
            <p>
            ...
            <p>
              ...
              Email: <a href="mailto:dmca@universaltowerdefensez.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@universaltowerdefensez.wiki</a>
            </p>
            <p>
            ...
            <p>
              Example attribution: <em>"Source: Universal Tower Defense Z Wiki (universaltowerdefensez.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@universaltowerdefensez.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@universaltowerdefensez.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@universaltowerdefensez.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@universaltowerdefensez.wiki</a>
            </p>
            <p>
